...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			window.onload = function(){
				...
				window.UEDITOR_CONFIG.imageUrl = "<?php echo U(GROUP_NAME.'/Article/uploadgif');?>";           //图片上传提交地址
	...
	<body>
		...
		<form method="post" action="<?php echo U(GROUP_NAME.'/Article/addgifRun');?>" enctype="multipart/form-data">
		<table class="table">
			<tr>
