                ...
                $.get(U('Ucenter/Public/getProfile'), {uid: uid}, function (userProfile) {
                    ...
                    if ((MID != uid) && (MID != 0)) {
                        ...
                        if (userProfile.followed == 1) {
                            follow += '<button type="button" class="btn btn-default" data-before="btn btn-primary" data-after="btn btn-default" data-role="unfollow" data-follow-who="'+userProfile.uid+'" style="float: right;margin: 5px 0;padding: 2px 12px;"><font title="取消关注">已关注</font></button>';
                        } else {
                            follow += '<button type="button" class="btn btn-primary" data-before="btn btn-primary" data-after="btn btn-default" data-role="follow" data-follow-who="'+userProfile.uid+'" style="float: right;margin: 5px 0;padding: 2px 12px;">关&nbsp;注</button>';
                        }
                    }
                    var html = '<div class="row" style="width: 350px;width: 350px;font-size: 13px;line-height: 23px;">' +
                        ...
                        '<img class="img-responsive" src="{$userProfile.cover_path}">' +
                        '</div>' +
