...
(10, 'add_weibo', '发布微博', '新增微博', 'a:1:{i:0;a:5:{s:5:"table";s:6:"member";s:5:"field";s:1:"1";s:4:"rule";s:3:"+10";s:5:"cycle";s:2:"24";s:3:"max";s:3:"100";}}', '[user|get_nickname]在[time|time_format]发布了新微博：[record|intval]', 1, 1, 1428397669, 'Weibo'),
(11, 'add_weibo_comment', '添加微博评论', '添加微博评论', 'a:1:{i:0;a:5:{s:5:"table";s:6:"member";s:5:"field";s:1:"1";s:4:"rule";s:2:"+5";s:5:"cycle";s:2:"24";s:3:"max";s:3:"100";}}', '[user|get_nickname]在[time|time_format]添加了微博评论：[record|intval]', 1, 1, 1428399164, 'Weibo'),
...
(126, 'USER_NAME_BAOLIU', 1, '保留用户名', 3, '', '禁止注册用户名,用" , "号隔开', 1388845937, 1388845937, 1, '管理员,测试,admin,垃圾', 0),
(127, 'USER_REG_TIME', 0, '注册时间限制', 3, '', '同一IP注册时间限制，防恶意注册，格式分钟', 1388847715, 1388847715, 1, '2', 0),
...
(133, 'USER_REG_WEIBO_CONTENT', 1, '用户注册微博提示内容', 3, '', '留空则表示不发新微博，支持face', 1404965285, 1404965445, 1, '', 0),
...
(181, '微博', 0, 8, 'Weibo/weibo', 1, '', '', 0, '', 'Weibo'),
(182, '微博管理', 181, 1, 'Weibo/weibo', 0, '', '微博', 0, '', 'Weibo'),
(183, '回复管理', 181, 3, 'Weibo/comment', 0, '', '回复', 0, '', 'Weibo'),
(184, '编辑微博', 181, 0, 'Weibo/editWeibo', 1, '', '', 0, '', 'Weibo'),
(185, '编辑回复', 181, 0, 'Weibo/editComment', 1, '', '', 0, '', 'Weibo'),
(186, '微博回收站', 181, 2, 'Weibo/weiboTrash', 0, '', '微博', 0, '', 'Weibo'),
(187, '回复回收站', 181, 4, 'Weibo/commentTrash', 0, '', '回复', 0, '', 'Weibo'),
(188, '微博设置', 181, 0, 'Weibo/config', 0, '微博的基本配置', '设置', 0, '', 'Weibo'),
(189, '话题管理', 181, 0, 'Weibo/topic', 0, '微博的话题', '话题管理', 0, '', 'Weibo'),
(190, '置顶微博', 181, 0, 'Weibo/setWeiboTop', 1, '', '', 0, '', 'Weibo'),
(191, '设置微博状态', 181, 0, 'Weibo/setWeiboStatus', 1, '', '', 0, '', 'Weibo'),
(192, '设置微博评论状态', 181, 0, 'Weibo/setCommentStatus', 1, '', '', 0, '', 'Weibo'),
