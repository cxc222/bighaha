        ...
        if ($res) {
            ...
            if (!is_login()) {
                if ($aUid) {
                    ...
                    D('Common/Message')->sendMessage($aUid, $title, $message, $aUrl, array('id' => $aRowId), 0);
                }
                $result['status'] = 1;
                $result['data'] = $html;
                $result['info'] = '评论成功';
            ...
            if ($aUid) {
                ...
                $message = '评论内容：' . $aContent;
                D('Common/Message')->sendMessage($aUid, $title, $message, $aUrl, array('id' => $aRowId));
            ...
            foreach ($uids as $uid) {
                ...
                D('Common/Message')->sendMessage($uid, $title, $message, $aUrl, array('id' => $aRowId));
            }
            $result['status'] = 1;
            $result['data'] = $html;
            $result['info'] = '评论成功';
