...
class uc_note {
	...
	function _serialize($arr, $htmlon = 0) {
		if(!function_exists('xml_serialize')) {
			include_once DISCUZ_ROOT.'./api/uc_client/lib/xml.class.php';
		}
	...
	function updatebadwords($get, $post) {
		...
		$cachefile = $this->appdir.'./api/uc_client/data/cache/badwords.php';
	...
	function updatehosts($get, $post) {
		...
		$cachefile = $this->appdir.'./api/uc_client/data/cache/hosts.php';
		$fp = fopen($cachefile, 'w');
		$s = "<?php\r\n";
	...
	function updateclient($get, $post) {
		...
		$cachefile = $this->appdir.'./api/uc_client/data/cache/settings.php';
		$fp = fopen($cachefile, 'w');
		$s = "<?php\r\n";
